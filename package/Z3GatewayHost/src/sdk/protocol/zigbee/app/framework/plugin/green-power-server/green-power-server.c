...
#ifdef EMBER_AF_API_GREEN_POWER_TRANSLATION_TABLE
                                        ...
                                        uint8_t groupcastRadius)
{
  ...
  #if (defined EMBER_AF_PLUGIN_GREEN_POWER_CLIENT \
       && !defined EZSP_HOST)
                            ...
                            bool setRemoveGpdflag)
{
  ...
  if (sinkEntryIndex != 0xFF) {
    ...
    #endif //EMBER_AF_PLUGIN_GREEN_POWER_TRANSLATION_TABLE
                                                            ...
                                                            uint8_t *reportDescriptor)
{
  ...
  if (gpConfigAtion == EMBER_ZCL_GP_PAIRING_CONFIGURATION_ACTION_REMOVE_A_PAIRING) {
    ...
    if (emberGpSinkTableLookup(&gpdAddr) != 0xFF) {
      ...
      #endif //EMBER_AF_PLUGIN_GREEN_POWER_SERVER_TRANSLATION_TABLE_SUPPORT
    }
    return true;
  }
