 ...
 *                                           OSIdleContextHook()
 *
 * @brief    Allows performing custom operations when idling.
 *
 * @note     (1) Allow the MCU to be put in sleep mode. Note that any context in this function will be
 *               lost when leaving idle mode.
 ********************************************************************************************************/
__WEAK void OSIdleContextHook(void);
