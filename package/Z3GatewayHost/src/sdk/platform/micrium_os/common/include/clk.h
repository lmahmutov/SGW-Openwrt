 ...
 * @{
 * @deprecated
 *   This module is deprecated and marked for removal in a later release.
 *   Use the new @ref SLEEPTIMER module instead.
 ********************************************************************************************************
 ...
 * @deprecated
 *           This data type is deprecated and marked for removal in a later release.
 *           Use the new @ref SLEEPTIMER module instead.
 *******************************************************************************************************/
...
#warning  "Clock module is deprecated. Consider migrating to the sleeptimer which offers the same set of functionality."
#if (CLK_CFG_EXT_EN == DEF_ENABLED)
#warning  "Sleeptimer and Clock external Timestamp are incompatible. Consider migrating to sleeptimer. " \
  "Clock external Timestamp is still valid if the sleeptimer is not present in the project"
#endif
#endif
