...
#define EMBER_AF_API_CJSON "../sdk/util/third_party/cjson/cJSON.h"

// API command-relay from Command Relay plugin
#define EMBER_AF_API_COMMAND_RELAY "../sdk/protocol/zigbee/app/framework/plugin/command-relay/command-relay.h"

// API device-table from Device Table plugin
#define EMBER_AF_API_DEVICE_TABLE "../sdk/protocol/zigbee/app/framework/plugin/device-table/device-table.h"

// API ezsp-protocol from EZSP Common plugin
#define EMBER_AF_API_EZSP_PROTOCOL "../sdk/protocol/zigbee/app/util/ezsp/ezsp-protocol.h"

// API ezsp from EZSP Common plugin
#define EMBER_AF_API_EZSP "../sdk/protocol/zigbee/app/util/ezsp/ezsp.h"

// API green-power-common from Green Power Common plugin
#define EMBER_AF_API_GREEN_POWER_COMMON "../sdk/protocol/zigbee/app/framework/plugin/green-power-common/green-power-common.h"

// API linked-list from Linked List plugin
#define EMBER_AF_API_LINKED_LIST "../sdk/util/plugin/plugin-common/linked-list/linked-list.h"

// API network-creator from Network Creator plugin
#define EMBER_AF_API_NETWORK_CREATOR "../sdk/protocol/zigbee/app/framework/plugin/network-creator/network-creator.h"

// API network-creator-security from Network Creator Security plugin
#define EMBER_AF_API_NETWORK_CREATOR_SECURITY "../sdk/protocol/zigbee/app/framework/plugin/network-creator-security/network-creator-security.h"

// API network-steering from Network Steering plugin
#define EMBER_AF_API_NETWORK_STEERING "../sdk/protocol/zigbee/app/framework/plugin/network-steering/network-steering.h"

// API scan-dispatch from Scan Dispatch plugin
#define EMBER_AF_API_SCAN_DISPATCH "../sdk/protocol/zigbee/app/framework/plugin/scan-dispatch/scan-dispatch.h"

// API ezsp-secure from EZSP Secure Protocol Stub plugin
#define EMBER_AF_API_EZSP_SECURE "../sdk/protocol/zigbee/app/util/ezsp/secure-ezsp-protocol.h"

// API transport-mqtt from Gateway MQTT Transport plugin
#define EMBER_AF_API_TRANSPORT_MQTT "../sdk/util/plugin/plugin-common/transport-mqtt/transport-mqtt.h"

// API crc from Unix Library plugin
#define EMBER_AF_API_CRC "../sdk/platform/base/hal/micro/crc.h"

// API endian from Unix Library plugin
#define EMBER_AF_API_ENDIAN "../sdk/platform/base/hal/micro/endian.h"

// API hal from Unix Library plugin
#define EMBER_AF_API_HAL "../sdk/platform/base/hal/hal.h"

// API random from Unix Library plugin
#define EMBER_AF_API_RANDOM "../sdk/platform/base/hal/micro/random.h"

// API system-timer from Unix Library plugin
#define EMBER_AF_API_SYSTEM_TIMER "../sdk/platform/base/hal/micro/system-timer.h"

// API update-tc-link-key from Update TC Link Key plugin
#define EMBER_AF_API_UPDATE_TC_LINK_KEY "../sdk/protocol/zigbee/app/framework/plugin/update-tc-link-key/update-tc-link-key.h"

// API command-interpreter2 from ZCL Framework Core plugin
#define EMBER_AF_API_COMMAND_INTERPRETER2 "../sdk/protocol/zigbee/app/util/serial/command-interpreter2.h"
